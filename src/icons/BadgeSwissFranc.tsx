...
export interface BadgeSwissFrancProps extends SvgProps {
  className?: string;
}

export const BadgeSwissFranc: React.FC<BadgeSwissFrancProps> = ({
  color = "#262626",

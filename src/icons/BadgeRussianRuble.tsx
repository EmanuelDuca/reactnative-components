...
export interface BadgeRussianRubleProps extends SvgProps {
  className?: string;
}

export const BadgeRussianRuble: React.FC<BadgeRussianRubleProps> = ({
  color = "#262626",

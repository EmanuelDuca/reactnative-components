...
export interface IceCreamConeProps extends SvgProps {
  className?: string;
}

export const IceCreamCone: React.FC<IceCreamConeProps> = ({
  color = "#262626",

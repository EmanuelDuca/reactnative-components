...
export interface StethoscopeProps extends SvgProps {
  className?: string;
}

export const Stethoscope: React.FC<StethoscopeProps> = ({
  color = "#262626",

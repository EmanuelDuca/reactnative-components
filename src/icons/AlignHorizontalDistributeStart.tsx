...
export interface AlignHorizontalDistributeStartProps extends SvgProps {
  className?: string;
}

export const AlignHorizontalDistributeStart: React.FC<AlignHorizontalDistributeStartProps> = ({
  color = "#262626",

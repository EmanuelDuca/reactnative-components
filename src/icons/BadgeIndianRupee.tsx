...
export interface BadgeIndianRupeeProps extends SvgProps {
  className?: string;
}

export const BadgeIndianRupee: React.FC<BadgeIndianRupeeProps> = ({
  color = "#262626",

...
export interface FileAudioProps extends SvgProps {
  className?: string;
}

export const FileAudio: React.FC<FileAudioProps> = ({
  color = "#262626",

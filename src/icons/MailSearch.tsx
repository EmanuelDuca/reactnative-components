...
export interface MailSearchProps extends SvgProps {
  className?: string;
}

export const MailSearch: React.FC<MailSearchProps> = ({
  color = "#262626",

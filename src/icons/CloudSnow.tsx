...
export interface CloudSnowProps extends SvgProps {
  className?: string;
}

export const CloudSnow: React.FC<CloudSnowProps> = ({
  color = "#262626",

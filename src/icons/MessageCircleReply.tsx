...
export interface MessageCircleReplyProps extends SvgProps {
  className?: string;
}

export const MessageCircleReply: React.FC<MessageCircleReplyProps> = ({
  color = "#262626",

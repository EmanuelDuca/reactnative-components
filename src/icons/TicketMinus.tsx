...
export interface TicketMinusProps extends SvgProps {
  className?: string;
}

export const TicketMinus: React.FC<TicketMinusProps> = ({
  color = "#262626",

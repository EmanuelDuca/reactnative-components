...
export interface FolderPlusProps extends SvgProps {
  className?: string;
}

export const FolderPlus: React.FC<FolderPlusProps> = ({
  color = "#262626",

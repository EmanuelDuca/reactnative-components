...
export interface TicketSlashProps extends SvgProps {
  className?: string;
}

export const TicketSlash: React.FC<TicketSlashProps> = ({
  color = "#262626",

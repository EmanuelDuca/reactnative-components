...
export interface CloudHailProps extends SvgProps {
  className?: string;
}

export const CloudHail: React.FC<CloudHailProps> = ({
  color = "#262626",

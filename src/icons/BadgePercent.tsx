...
export interface BadgePercentProps extends SvgProps {
  className?: string;
}

export const BadgePercent: React.FC<BadgePercentProps> = ({
  color = "#262626",

...
export interface HandCoinsProps extends SvgProps {
  className?: string;
}

export const HandCoins: React.FC<HandCoinsProps> = ({
  color = "#262626",

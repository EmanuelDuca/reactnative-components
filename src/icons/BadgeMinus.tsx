...
export interface BadgeMinusProps extends SvgProps {
  className?: string;
}

export const BadgeMinus: React.FC<BadgeMinusProps> = ({
  color = "#262626",

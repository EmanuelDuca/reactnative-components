...
export interface FolderHeartProps extends SvgProps {
  className?: string;
}

export const FolderHeart: React.FC<FolderHeartProps> = ({
  color = "#262626",

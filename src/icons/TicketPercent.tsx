...
export interface TicketPercentProps extends SvgProps {
  className?: string;
}

export const TicketPercent: React.FC<TicketPercentProps> = ({
  color = "#262626",

...
export interface FolderGit2Props extends SvgProps {
  className?: string;
}

export const FolderGit2: React.FC<FolderGit2Props> = ({
  color = "#262626",

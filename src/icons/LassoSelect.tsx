...
export interface LassoSelectProps extends SvgProps {
  className?: string;
}

export const LassoSelect: React.FC<LassoSelectProps> = ({
  color = "#262626",

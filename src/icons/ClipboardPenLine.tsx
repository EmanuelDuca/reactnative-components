...
export interface ClipboardPenLineProps extends SvgProps {
  className?: string;
}

export const ClipboardPenLine: React.FC<ClipboardPenLineProps> = ({
  color = "#262626",

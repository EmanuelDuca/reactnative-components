...
export interface CloudDrizzleProps extends SvgProps {
  className?: string;
}

export const CloudDrizzle: React.FC<CloudDrizzleProps> = ({
  color = "#262626",

...
export interface ShieldQuestionProps extends SvgProps {
  className?: string;
}

export const ShieldQuestion: React.FC<ShieldQuestionProps> = ({
  color = "#262626",

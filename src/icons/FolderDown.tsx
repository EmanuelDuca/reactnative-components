...
export interface FolderDownProps extends SvgProps {
  className?: string;
}

export const FolderDown: React.FC<FolderDownProps> = ({
  color = "#262626",

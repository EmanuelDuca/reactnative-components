...
export interface CloudRainWindProps extends SvgProps {
  className?: string;
}

export const CloudRainWind: React.FC<CloudRainWindProps> = ({
  color = "#262626",

...
export interface BadgeHelpProps extends SvgProps {
  className?: string;
}

export const BadgeHelp: React.FC<BadgeHelpProps> = ({
  color = "#262626",

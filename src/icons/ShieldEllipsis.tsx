...
export interface ShieldEllipsisProps extends SvgProps {
  className?: string;
}

export const ShieldEllipsis: React.FC<ShieldEllipsisProps> = ({
  color = "#262626",

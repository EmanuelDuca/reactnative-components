...
export interface FolderSearch2Props extends SvgProps {
  className?: string;
}

export const FolderSearch2: React.FC<FolderSearch2Props> = ({
  color = "#262626",

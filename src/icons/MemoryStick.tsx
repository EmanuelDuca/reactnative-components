...
export interface MemoryStickProps extends SvgProps {
  className?: string;
}

export const MemoryStick: React.FC<MemoryStickProps> = ({
  color = "#262626",

...
export interface FolderArchiveProps extends SvgProps {
  className?: string;
}

export const FolderArchive: React.FC<FolderArchiveProps> = ({
  color = "#262626",

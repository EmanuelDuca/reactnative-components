...
export interface CloudDownloadProps extends SvgProps {
  className?: string;
}

export const CloudDownload: React.FC<CloudDownloadProps> = ({
  color = "#262626",

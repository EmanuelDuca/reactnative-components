...
export interface BadgePlusProps extends SvgProps {
  className?: string;
}

export const BadgePlus: React.FC<BadgePlusProps> = ({
  color = "#262626",

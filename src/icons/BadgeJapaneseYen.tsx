...
export interface BadgeJapaneseYenProps extends SvgProps {
  className?: string;
}

export const BadgeJapaneseYen: React.FC<BadgeJapaneseYenProps> = ({
  color = "#262626",

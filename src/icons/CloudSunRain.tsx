...
export interface CloudSunRainProps extends SvgProps {
  className?: string;
}

export const CloudSunRain: React.FC<CloudSunRainProps> = ({
  color = "#262626",

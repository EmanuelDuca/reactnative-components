...
export interface TicketCheckProps extends SvgProps {
  className?: string;
}

export const TicketCheck: React.FC<TicketCheckProps> = ({
  color = "#262626",

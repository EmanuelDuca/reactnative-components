...
export interface RotateCcwSquareProps extends SvgProps {
  className?: string;
}

export const RotateCcwSquare: React.FC<RotateCcwSquareProps> = ({
  color = "#262626",

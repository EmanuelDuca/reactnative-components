...
export interface BadgePoundSterlingProps extends SvgProps {
  className?: string;
}

export const BadgePoundSterling: React.FC<BadgePoundSterlingProps> = ({
  color = "#262626",

...
export interface SquareScissorsProps extends SvgProps {
  className?: string;
}

export const SquareScissors: React.FC<SquareScissorsProps> = ({
  color = "#262626",

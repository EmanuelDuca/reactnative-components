...
export interface FolderCheckProps extends SvgProps {
  className?: string;
}

export const FolderCheck: React.FC<FolderCheckProps> = ({
  color = "#262626",

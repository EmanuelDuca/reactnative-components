...
export interface FolderCogProps extends SvgProps {
  className?: string;
}

export const FolderCog: React.FC<FolderCogProps> = ({
  color = "#262626",

...
import { ChevronsUpDown, ChevronUp } from "@usekeyhole/nativewind";
import { Button, ButtonIcon } from "@usekeyhole/nativewind";
...
export const AccordionTableRow: React.FC<AccordionTableRowProps> = ({
  ...
  return (
    <AccordionItem value={value} className="gap-0">
...
export const TablePagination: React.FC<TablePaginationProps> = ({
  ...
  const pageNumbers = React.useMemo(() => {
    ...
    // Clamp start & end inside [2, totalPages-1]
    if (start < 2) {
      start = 2;
